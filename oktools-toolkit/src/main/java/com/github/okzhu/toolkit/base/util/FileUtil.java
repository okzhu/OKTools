...
public class FileUtil {
     ...
     * @see Files#newInputStream
     */
    public static InputStream asInputStream(@NonNull Path path) throws IOException {
     ...
     * @see Files#newOutputStream
     */
    public static OutputStream asOutputStream(@NonNull File file) throws IOException {
     ...
     * @see Files#newOutputStream
     */
    public static OutputStream asOutputStream(@NonNull Path path) throws IOException {
     ...
     */
    public static BufferedReader asBufferedReader(@NotBlank String fileName) throws IOException {
        Validate.notBlank(fileName, "filename is blank");
        return asBufferedReader(getPath(fileName));
    }

    public static BufferedReader asBufferedReader(@NonNull Path path) throws IOException {
     ...
     * @see Files#newBufferedWriter
     */
    public static BufferedWriter asBufferedWriter(@NonNull Path path) throws IOException {
    ...
    public static void copyFile(@NonNull Path from, @NonNull Path to) throws IOException {
        Validate.isTrue(Files.exists(from), NOT_FILE, from);
        Validate.notNull(to);
    ...
    public static void copyDir(@NonNull File from, @NonNull File to) throws IOException {
        Validate.isTrue(isDirExists(from), NOT_DIR, from);
        Validate.notNull(to);
    ...
    public static void moveFile(@NonNull Path from, @NonNull Path to) throws IOException {
        Validate.isTrue(isFileExists(from), NOT_FILE, from);
        Validate.notNull(to);
    ...
    public static void deleteFile(@NonNull File file) throws IOException {
        Validate.isTrue(isFileExists(file), NOT_FILE, file);
     ...
     * 如果文件不存在或者是目录，则不做修改
     */
    public static void deleteFile(@NonNull Path path) throws IOException {
        Validate.isTrue(isFileExists(path), NOT_FILE, path);
    ...
    public static void deleteDir(Path dir) throws IOException {
        Validate.isTrue(isDirExists(dir), NOT_DIR, dir);
